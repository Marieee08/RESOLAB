...
const EditableCalendar: React.FC = () => {
  ...
  return (
    <div className="calendar border border-[#143370]">
      <style jsx>{`
        .calendar {
          width: 100%;
          max-width: 1200px;
      ...
      <div className="calendar-header ">
        ...
        <h2 className="text-xl font-qanelas2 text-[#143370]">{currentDate.toLocaleString('default', { month: 'long', year: 'numeric' })}</h2>
        <button onClick={nextMonth}>&gt;</button>
      </div>
      <div className="calendar-body ">
        {['Sun', 'Mon', 'Tue', 'Wed', 'Thu', 'Fri', 'Sat'].map((day) => (
          <div key={day} className="calendar-day-name text-xl font-qanelas2 text-[#143370]">{day}</div>
        ))}
